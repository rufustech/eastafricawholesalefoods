        ...
        <section className="relative isolate border-b border-[#173b2b]/10 bg-[#f5ead5] dark:border-white/10 dark:bg-[#173b2b]">
          ...
          <div className="container grid items-center gap-12 py-16 md:grid-cols-[1.05fr_0.95fr] md:py-24 lg:gap-20 lg:py-28">
            <div>
              ...
              <div className="mt-9 flex flex-wrap items-center gap-4"><Link href="/products" className="rounded-full bg-[#1f633f] px-7 py-4 text-sm font-bold text-white shadow-xl shadow-[#1f633f]/25 transition-all hover:-translate-y-1 hover:bg-[#174d30]">Browse the collection <span className="ml-2">-&gt;</span></Link><a href="#story" className="rounded-full border border-[#173b2b]/20 px-7 py-4 text-sm font-bold transition-colors hover:border-[#d64b35] hover:text-[#d64b35] dark:border-white/20">Why us?</a></div>
