    ...
    <div className="grid min-h-screen place-items-center bg-[#173b2b] text-[#f8f2e5]">
      <div className="flex flex-col items-center">
        <div className="relative grid h-64 w-64 place-items-center">
          ...
          <svg
            className="animate-spin-counter absolute inset-0 h-full w-full"
            viewBox="0 0 256 256"
            aria-label="East Africa Wholesale Foods loading"
          >
            <defs>
              <path
                id="brand-spinner-route"
          ...
          <div className="relative text-center">
            ...
            <span className="mt-2 block text-sm font-bold uppercase tracking-[0.25em] text-[#e8846f]">
              Organic Foods
            </span>
          </div>
        </div>
