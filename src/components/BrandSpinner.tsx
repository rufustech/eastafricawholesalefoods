    ...
    <div className="grid min-h-screen place-items-center bg-[#173b2b] text-[#f8f2e5]">
      <div className="flex flex-col items-center">
        <div className="relative grid h-64 w-64 place-items-center">
          ...
          <svg className="animate-spin-counter absolute inset-0 h-full w-full" viewBox="0 0 256 256" aria-label="East Africa Wholesale Foods loading">
            <defs><path id="brand-spinner-route" d="M 128,128 m -92,0 a 92,92 0 1,1 184,0 a 92,92 0 1,1 -184,0" /></defs>
            <text className="fill-[#f8f2e5] text-[13px] font-bold uppercase tracking-[0.28em]"><textPath href="#brand-spinner-route" startOffset="0%" textLength="250" lengthAdjust="spacing">EAST AFRICA WHOLESALE FOODS</textPath><textPath href="#brand-spinner-route" startOffset="50%" textLength="250" lengthAdjust="spacing">EAST AFRICA WHOLESALE FOODS</textPath></text>
          </svg>
